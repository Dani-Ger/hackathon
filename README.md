...
##Challenge Details:
Create a digital game inspired by the Museum. Teams must have two to six members. Bring a team or form one at the kickoff.
...
1. Start by buying a Hackathon entry here. To submit a project on DevPost, you will be asked for your Order Confirmation number on your Hackathon entry from the Philadelphia Museum of Art.
2. Register on DevPost, create a project, and add your teammates.
3. Spend April with your team to build a game that wows the judges and the public. Museum staff will be available in person and online at specific times- further information will be shared with participants.
4. Submit a write up of your project, along with screen shots and a 2 minute video demo to DevPost and submit a working demo app of your project on Github by 10PM EDT, May 9. 
...
To make clear what is expected, all participants associated with the Philadelphia Museum of Art Hackathon are required to adhere to the following Code of Conduct.
